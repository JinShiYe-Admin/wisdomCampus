	...
	mod.setPic = function(img, flag, thumb) {
		...
		if(img.type == 1) {
			if(flag) {
				...
				div.innerHTML = '<div class="clip-container"  style="width:' + div_width * 0.9 + 'px;height:' + div_width * 0.9 + 'px;margin:5%;overflow:hidden;display:inline-block;backgroud:red"><img src="' +
